...
def trainRead(in_file):    
    ...
    for current_time_window in time_windows:
        ...
        for i in range(len(time_slots)):
            l = time_slots[i]
            if i == 0:
                current_x = [1,0,weekday,day,l[-6],l[-5],l[-4],l[-3],l[-2],l[-1]]
            elif i==1:
                current_x = [1,1,weekday,day,l[-6],l[-5],l[-4],l[-3],l[-2],l[-1]]
            elif i == 2:
                current_x = [2,0,weekday,day,l[-6],l[-5],l[-4],l[-3],l[-2],l[-1]]
            elif i==3:
                current_x = [3,0,weekday,day,l[-6],l[-5],l[-4],l[-3],l[-2],l[-1]]
            else:
                current_x = [3,1,weekday,day,l[-6],l[-5],l[-4],l[-3],l[-2],l[-1]]
...
def test(in_file):
    ...
    for current_time_window in time_windows:
        if current_time_window.hour !=6 and current_time_window != 15:
            continue
        ...
        weekday = current_time_window.weekday()
        day = current_time_window.day
        predict_time_window = current_time_window + timedelta(hours=2)
